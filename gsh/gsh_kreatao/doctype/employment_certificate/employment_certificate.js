    ...
    after_save: function(frm) {
        if (!frm.is_new()) {
            ...
            if (!frm.doc.content_1) {
                frm.set_value("content_1", `<p style="margin:0;padding:0;"><b>Re Number: ${re_number}</b></p><p style="margin:0;padding:0;"><b>Date: ${formatted_date}</b></p><p style="text-align:center;margin:0;padding:0;"><u><b>EMPLOYMENT CERTIFICATE</b></u></p>`);
            }
